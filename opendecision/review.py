"""Minimal human-review workflow and loop protection."""
...
class InMemoryReviewStore:
    ...
    def create(self, action_id: str, result: DecisionResult) -> ReviewRequest:
        attempts = sum(item.action_id == action_id for item in self.requests.values())
        if attempts >= self.max_attempts_per_action:
